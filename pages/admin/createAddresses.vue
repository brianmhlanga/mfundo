    ...
    <NuxtLayout name="dashboard">
        <section class="section">
            <div class="container-fluid pt-5">
                <div class="row">
                    <div class="text-900 font-medium text-xl mb-3">Addresses</div>
                    <div class="surface-card p-4 shadow-2 border-round p-fluid">
                        <div class="grid formgrid p-fluid">
                          
                           
                            <div class="field mb-4 col-12 md:col-6">
                                <Button @click="addLineItem = true" label="Add Address" icon="pi pi-plus" class="p-button p-component p-button-secondary p-button-outlined w-auto" outlined />
                            </div>
                            <div class="field mb-4 col-12 md:col-12"> 
                                <label for="customer_name" class="font-medium text-900">Addresses</label> 
                                <DataTable :value="addresses" showGridlines tableStyle="min-width: 50rem">
                                    <Column field="price" header="Address Code">
                                        <template #body="slotProps">
                                            {{slotProps.data.code}}
                                        </template>
                                    </Column>
                                    <Column field="rating" header="Address Description">
                                        <template #body="slotProps">
                                            {{slotProps.data.description}}
                                        </template>
                                    </Column>
                                    <Column field="rating" header="Address Number">
                                        <template #body="slotProps">
                                            {{slotProps.data.address_number}}
                                        </template>
                                    </Column>
        ...
        <Dialog v-model:visible="addLineItem" maximizable modal header="Create Address" position="top" :style="{ width: '75vw' }">
                <div class="grid formgrid p-fluid">
                    <div class="field mb-4 col-12 md:col-6"> 
                        <label  for="company_name" class="font-medium text-900">Address Code</label> 
                        <InputText v-model="code" placeholder="Address Code" />
                    </div>
                    <div class="field mb-4 col-12 md:col-6"> 
