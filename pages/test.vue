        ...
        <header>
            <div class="custom-container">
                <div class="header-area">
                    ...
                    <NuxtLink v-if="first_name" to="/register" class="custom-button"><span>Log Out</span></NuxtLink>
                    <NuxtLink v-else to="/login" class="custom-buttonn"><span>Log In</span></NuxtLink>
                    <NuxtLink v-else to="/register" class="custom-button"><span>Sign Up</span></NuxtLink>
                </div>
            </div>
        </header>
        <!-- ~~~ Header Section ~~~ -->
